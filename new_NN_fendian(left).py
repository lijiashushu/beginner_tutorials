...
class JointControl(object):
    def __init__(self, ArmName):
        ...
        self.torController[0].set_kd(2.1)  # 10#15#0.01#*0.6#21.0

        self.torController[1].set_kp(20)  # 130#80.0#*0.6
        self.torController[1].set_ki(6)
        self.torController[1].set_kd(2.2)  # 10#15#0.01#*0.6#21.0
        ...
        self.torController[3].set_kd(2.00)  # 10#15#0.01#*0.6#21.0

        self.torController[4].set_kp(20.3)
        self.torController[4].set_ki(0.1) #0.1
        self.torController[4].set_kd(5.1)

        self.torController[5].set_kp(12.6)  # 130#80.0#*0.6
        self.torController[5].set_ki(1.5) #0.05
        self.torController[5].set_kd(10.1)  # 10#15#0.01#*0.6#21.0
